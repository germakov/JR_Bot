...
client = AsyncOpenAI(base_url="https://openai.javarush.com/v1", api_key=CHATGPT_TOKEN)
...
async def get_chatgpt_response(user_message: str):
    ...
    try:
        ...
        return (
            "😔 Извините, произошла ошибка при обращении к ChatGPT. Попробуйте позже!"
        )
...
async def get_personality_response(user_message: str, personality_prompt: str):
    ...
    try:
        ...
        return (
            "😔 Извините, произошла ошибка при обращении к личности. Попробуйте позже!"
        )
